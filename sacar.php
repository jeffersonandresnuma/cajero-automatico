...
<body>
	...
	<div class="row justify-content-center">
		<div class="col-md-4">
			<form action="sacar2.php" method="POST">
	        <table class="table table-bordered table-hover" style="width:100%">
	        <h6>por favor ingrese el valor que desea retirar</h6>
	        <tr>
	        <th>Monto</th>
	        </tr>
	        <tr>
	        <td><input type="number"  class="form-control" name="sacar" required id="sacar" placeholder="Ej: 1234..."></td>
	        </tr>
	        </table>
